...
function game(){
  alert(`Hey ${userName}, thank you so much for answering my questions! But we're not done! Now let's play a little number guessing game. Try to guess a number between 1 and 10. You have 4 guesses. Good luck! `);
